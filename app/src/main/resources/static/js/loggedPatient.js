...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.log("elements:", { searchBar, filterTime, filterSpecialty });

  if (searchBar) {
    searchBar.addEventListener("input", () => {
      console.log("search input fired", searchBar.value);
  ...
  if (filterTime) {
    filterTime.addEventListener("change", () => {
      console.log("time change fired", filterTime.value);
      filterDoctorsOnChange();
    });
  }
  ...
  if (filterSpecialty) {
    filterSpecialty.addEventListener("change", () => {
      console.log("specialty change fired", filterSpecialty.value);
      filterDoctorsOnChange();
    });
  }
});
...
function filterDoctorsOnChange() {
  console.log("filterDoctorsOnChange fired");
