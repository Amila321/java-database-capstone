...
public class DoctorController {
    ...
    public ResponseEntity<Map<String, Object>> getDoctorAvailability(
        ...
        Map<String, String> tokenValidation = service.validateToken(token, user);
        if (!tokenValidation.isEmpty()) {
            Map<String, Object> response = new HashMap<>();
            response.put("message", tokenValidation.get("message"));
            response.put("availability", List.of());
        ...
        if (availability.isEmpty()) {
            response.put("message", "No available slots found.");
        }
    ...
    public ResponseEntity<Map<String, String>> saveDoctor(
        ...
        Map<String, String> tokenValidation = service.validateToken(token, "admin");
        if (!tokenValidation.isEmpty()) {
